...
-- ** Int8X4
data Int8X4 = Int8X4 Int# Int# Int# Int# deriving Typeable
...
broadcastInt8X4 (I8# x) = case broadcastInt8# x of
    v -> Int8X4 v v v v

{-# INLINE packInt8X4 #-}
-- | Pack the elements of a tuple into a vector.
packInt8X4 :: (Int8, Int8, Int8, Int8) -> Int8X4
packInt8X4 (I8# x1, I8# x2, I8# x3, I8# x4) = Int8X4 (packInt8# (# x1 #)) (packInt8# (# x2 #)) (packInt8# (# x3 #)) (packInt8# (# x4 #))

{-# INLINE unpackInt8X4 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt8X4 :: Int8X4 -> (Int8, Int8, Int8, Int8)
unpackInt8X4 (Int8X4 m1 m2 m3 m4) = case unpackInt8# m1 of
    (# x1 #) -> case unpackInt8# m2 of
        (# x2 #) -> case unpackInt8# m3 of
            (# x3 #) -> case unpackInt8# m4 of
                (# x4 #) -> (I8# x1, I8# x2, I8# x3, I8# x4)

{-# INLINE unsafeInsertInt8X4 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt8X4 :: Int8X4 -> Int8 -> Int -> Int8X4
unsafeInsertInt8X4 (Int8X4 m1 m2 m3 m4) (I8# y) _i@(I# ip) | _i < 1 = Int8X4 (insertInt8# m1 y (ip -# 0#)) m2 m3 m4
                                                           | _i < 2 = Int8X4 m1 (insertInt8# m2 y (ip -# 1#)) m3 m4
                                                           | _i < 3 = Int8X4 m1 m2 (insertInt8# m3 y (ip -# 2#)) m4
                                                           | otherwise = Int8X4 m1 m2 m3 (insertInt8# m4 y (ip -# 3#))
...
plusInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) (Int8X4 m1_2 m2_2 m3_2 m4_2) = Int8X4 (plusInt8# m1_1 m1_2) (plusInt8# m2_1 m2_2) (plusInt8# m3_1 m3_2) (plusInt8# m4_1 m4_2)

{-# INLINE minusInt8X4 #-}
-- | Subtract two vectors element-wise.
minusInt8X4 :: Int8X4 -> Int8X4 -> Int8X4
minusInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) (Int8X4 m1_2 m2_2 m3_2 m4_2) = Int8X4 (minusInt8# m1_1 m1_2) (minusInt8# m2_1 m2_2) (minusInt8# m3_1 m3_2) (minusInt8# m4_1 m4_2)

{-# INLINE timesInt8X4 #-}
-- | Multiply two vectors element-wise.
timesInt8X4 :: Int8X4 -> Int8X4 -> Int8X4
timesInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) (Int8X4 m1_2 m2_2 m3_2 m4_2) = Int8X4 (timesInt8# m1_1 m1_2) (timesInt8# m2_1 m2_2) (timesInt8# m3_1 m3_2) (timesInt8# m4_1 m4_2)

{-# INLINE quotInt8X4 #-}
-- | Rounds towards zero element-wise.
quotInt8X4 :: Int8X4 -> Int8X4 -> Int8X4
quotInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) (Int8X4 m1_2 m2_2 m3_2 m4_2) = Int8X4 (quotInt8# m1_1 m1_2) (quotInt8# m2_1 m2_2) (quotInt8# m3_1 m3_2) (quotInt8# m4_1 m4_2)

{-# INLINE remInt8X4 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt8X4 :: Int8X4 -> Int8X4 -> Int8X4
remInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) (Int8X4 m1_2 m2_2 m3_2 m4_2) = Int8X4 (remInt8# m1_1 m1_2) (remInt8# m2_1 m2_2) (remInt8# m3_1 m3_2) (remInt8# m4_1 m4_2)

{-# INLINE negateInt8X4 #-}
-- | Negate element-wise.
negateInt8X4 :: Int8X4 -> Int8X4
negateInt8X4 (Int8X4 m1_1 m2_1 m3_1 m4_1) = Int8X4 (negateInt8# m1_1) (negateInt8# m2_1) (negateInt8# m3_1) (negateInt8# m4_1)

{-# INLINE indexInt8X4Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt8X4Array :: ByteArray -> Int -> Int8X4
indexInt8X4Array (ByteArray a) (I# i) = Int8X4 (indexInt8Array# a ((i *# 4#) +# 0#)) (indexInt8Array# a ((i *# 4#) +# 1#)) (indexInt8Array# a ((i *# 4#) +# 2#)) (indexInt8Array# a ((i *# 4#) +# 3#))

{-# INLINE readInt8X4Array #-}
-- | Read a vector from specified index of the mutable array.
readInt8X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int8X4
readInt8X4Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt8Array# a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case readInt8Array# a ((i *# 4#) +# 1#) s1 of
        (# s2, m2 #) -> case readInt8Array# a ((i *# 4#) +# 2#) s2 of
            (# s3, m3 #) -> case readInt8Array# a ((i *# 4#) +# 3#) s3 of
                (# s4, m4 #) -> (# s4, Int8X4 m1 m2 m3 m4 #))

{-# INLINE writeInt8X4Array #-}
-- | Write a vector to specified index of mutable array.
writeInt8X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int8X4 -> m ()
writeInt8X4Array (MutableByteArray a) (I# i) (Int8X4 m1 m2 m3 m4) = primitive_ (writeInt8Array# a ((i *# 4#) +# 0#) m1) >> primitive_ (writeInt8Array# a ((i *# 4#) +# 1#) m2) >> primitive_ (writeInt8Array# a ((i *# 4#) +# 2#) m3) >> primitive_ (writeInt8Array# a ((i *# 4#) +# 3#) m4)

{-# INLINE indexInt8X4OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt8X4OffAddr :: Addr -> Int -> Int8X4
indexInt8X4OffAddr (Addr a) (I# i) = Int8X4 (indexInt8OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0#) (indexInt8OffAddr# (plusAddr# a ((i *# 4#) +# 1#)) 0#) (indexInt8OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0#) (indexInt8OffAddr# (plusAddr# a ((i *# 4#) +# 3#)) 0#)

{-# INLINE readInt8X4OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt8X4OffAddr :: PrimMonad m => Addr -> Int -> m Int8X4
readInt8X4OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readInt8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 1#) s1 of
        (# s2, m2 #) -> case (\ addr i' -> readInt8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 2#) s2 of
            (# s3, m3 #) -> case (\ addr i' -> readInt8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 3#) s3 of
                (# s4, m4 #) -> (# s4, Int8X4 m1 m2 m3 m4 #))

{-# INLINE writeInt8X4OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt8X4OffAddr :: PrimMonad m => Addr -> Int -> Int8X4 -> m ()
writeInt8X4OffAddr (Addr a) (I# i) (Int8X4 m1 m2 m3 m4) = primitive_ (writeInt8OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0# m1) >> primitive_ (writeInt8OffAddr# (plusAddr# a ((i *# 4#) +# 1#)) 0# m2) >> primitive_ (writeInt8OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0# m3) >> primitive_ (writeInt8OffAddr# (plusAddr# a ((i *# 4#) +# 3#)) 0# m4)
