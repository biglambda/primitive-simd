...
-- ** FloatX2
data FloatX2 = FloatX2 Float# Float# deriving Typeable
...
broadcastFloatX2 (F# x) = case broadcastFloat# x of
    v -> FloatX2 v v

{-# INLINE packFloatX2 #-}
-- | Pack the elements of a tuple into a vector.
packFloatX2 :: (Float, Float) -> FloatX2
packFloatX2 (F# x1, F# x2) = FloatX2 (packFloat# (# x1 #)) (packFloat# (# x2 #))

{-# INLINE unpackFloatX2 #-}
-- | Unpack the elements of a vector into a tuple.
unpackFloatX2 :: FloatX2 -> (Float, Float)
unpackFloatX2 (FloatX2 m1 m2) = case unpackFloat# m1 of
...
unsafeInsertFloatX2 (FloatX2 m1 m2) (F# y) _i@(I# ip) | _i < 1 = FloatX2 (insertFloat# m1 y (ip -# 0#)) m2
                                                      | otherwise = FloatX2 m1 (insertFloat# m2 y (ip -# 1#))
...
plusFloatX2 (FloatX2 m1_1 m2_1) (FloatX2 m1_2 m2_2) = FloatX2 (plusFloat# m1_1 m1_2) (plusFloat# m2_1 m2_2)

{-# INLINE minusFloatX2 #-}
-- | Subtract two vectors element-wise.
minusFloatX2 :: FloatX2 -> FloatX2 -> FloatX2
minusFloatX2 (FloatX2 m1_1 m2_1) (FloatX2 m1_2 m2_2) = FloatX2 (minusFloat# m1_1 m1_2) (minusFloat# m2_1 m2_2)

{-# INLINE timesFloatX2 #-}
-- | Multiply two vectors element-wise.
timesFloatX2 :: FloatX2 -> FloatX2 -> FloatX2
timesFloatX2 (FloatX2 m1_1 m2_1) (FloatX2 m1_2 m2_2) = FloatX2 (timesFloat# m1_1 m1_2) (timesFloat# m2_1 m2_2)

{-# INLINE divideFloatX2 #-}
-- | Divide two vectors element-wise.
divideFloatX2 :: FloatX2 -> FloatX2 -> FloatX2
divideFloatX2 (FloatX2 m1_1 m2_1) (FloatX2 m1_2 m2_2) = FloatX2 (divideFloat# m1_1 m1_2) (divideFloat# m2_1 m2_2)

{-# INLINE negateFloatX2 #-}
-- | Negate element-wise.
negateFloatX2 :: FloatX2 -> FloatX2
negateFloatX2 (FloatX2 m1_1 m2_1) = FloatX2 (negateFloat# m1_1) (negateFloat# m2_1)

{-# INLINE indexFloatX2Array #-}
-- | Read a vector from specified index of the immutable array.
indexFloatX2Array :: ByteArray -> Int -> FloatX2
indexFloatX2Array (ByteArray a) (I# i) = FloatX2 (indexFloatArray# a ((i *# 2#) +# 0#)) (indexFloatArray# a ((i *# 2#) +# 1#))

{-# INLINE readFloatX2Array #-}
-- | Read a vector from specified index of the mutable array.
readFloatX2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m FloatX2
readFloatX2Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readFloatArray# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readFloatArray# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, FloatX2 m1 m2 #))

{-# INLINE writeFloatX2Array #-}
-- | Write a vector to specified index of mutable array.
writeFloatX2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> FloatX2 -> m ()
writeFloatX2Array (MutableByteArray a) (I# i) (FloatX2 m1 m2) = primitive_ (writeFloatArray# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeFloatArray# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexFloatX2OffAddr #-}
-- | Reads vector from the specified index of the address.
indexFloatX2OffAddr :: Addr -> Int -> FloatX2
indexFloatX2OffAddr (Addr a) (I# i) = FloatX2 (indexFloatOffAddr# (plusAddr# a ((i *# 8#) +# 0#)) 0#) (indexFloatOffAddr# (plusAddr# a ((i *# 8#) +# 4#)) 0#)

{-# INLINE readFloatX2OffAddr #-}
-- | Reads vector from the specified index of the address.
readFloatX2OffAddr :: PrimMonad m => Addr -> Int -> m FloatX2
readFloatX2OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readFloatOffAddr# (plusAddr# addr i') 0#) a ((i *# 8#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readFloatOffAddr# (plusAddr# addr i') 0#) a ((i *# 8#) +# 4#) s1 of
        (# s2, m2 #) -> (# s2, FloatX2 m1 m2 #))

{-# INLINE writeFloatX2OffAddr #-}
-- | Write vector to the specified index of the address.
writeFloatX2OffAddr :: PrimMonad m => Addr -> Int -> FloatX2 -> m ()
writeFloatX2OffAddr (Addr a) (I# i) (FloatX2 m1 m2) = primitive_ (writeFloatOffAddr# (plusAddr# a ((i *# 8#) +# 0#)) 0# m1) >> primitive_ (writeFloatOffAddr# (plusAddr# a ((i *# 8#) +# 4#)) 0# m2)
