...
-- ** Word8X4
data Word8X4 = Word8X4 Word# Word# Word# Word# deriving Typeable
...
broadcastWord8X4 (W8# x) = case broadcastWord8# x of
    v -> Word8X4 v v v v

{-# INLINE packWord8X4 #-}
-- | Pack the elements of a tuple into a vector.
packWord8X4 :: (Word8, Word8, Word8, Word8) -> Word8X4
packWord8X4 (W8# x1, W8# x2, W8# x3, W8# x4) = Word8X4 (packWord8# (# x1 #)) (packWord8# (# x2 #)) (packWord8# (# x3 #)) (packWord8# (# x4 #))

{-# INLINE unpackWord8X4 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord8X4 :: Word8X4 -> (Word8, Word8, Word8, Word8)
unpackWord8X4 (Word8X4 m1 m2 m3 m4) = case unpackWord8# m1 of
    (# x1 #) -> case unpackWord8# m2 of
        (# x2 #) -> case unpackWord8# m3 of
            (# x3 #) -> case unpackWord8# m4 of
                (# x4 #) -> (W8# x1, W8# x2, W8# x3, W8# x4)

{-# INLINE unsafeInsertWord8X4 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord8X4 :: Word8X4 -> Word8 -> Int -> Word8X4
unsafeInsertWord8X4 (Word8X4 m1 m2 m3 m4) (W8# y) _i@(I# ip) | _i < 1 = Word8X4 (insertWord8# m1 y (ip -# 0#)) m2 m3 m4
                                                             | _i < 2 = Word8X4 m1 (insertWord8# m2 y (ip -# 1#)) m3 m4
                                                             | _i < 3 = Word8X4 m1 m2 (insertWord8# m3 y (ip -# 2#)) m4
                                                             | otherwise = Word8X4 m1 m2 m3 (insertWord8# m4 y (ip -# 3#))
...
plusWord8X4 (Word8X4 m1_1 m2_1 m3_1 m4_1) (Word8X4 m1_2 m2_2 m3_2 m4_2) = Word8X4 (plusWord8# m1_1 m1_2) (plusWord8# m2_1 m2_2) (plusWord8# m3_1 m3_2) (plusWord8# m4_1 m4_2)

{-# INLINE minusWord8X4 #-}
-- | Subtract two vectors element-wise.
minusWord8X4 :: Word8X4 -> Word8X4 -> Word8X4
minusWord8X4 (Word8X4 m1_1 m2_1 m3_1 m4_1) (Word8X4 m1_2 m2_2 m3_2 m4_2) = Word8X4 (minusWord8# m1_1 m1_2) (minusWord8# m2_1 m2_2) (minusWord8# m3_1 m3_2) (minusWord8# m4_1 m4_2)

{-# INLINE timesWord8X4 #-}
-- | Multiply two vectors element-wise.
timesWord8X4 :: Word8X4 -> Word8X4 -> Word8X4
timesWord8X4 (Word8X4 m1_1 m2_1 m3_1 m4_1) (Word8X4 m1_2 m2_2 m3_2 m4_2) = Word8X4 (timesWord8# m1_1 m1_2) (timesWord8# m2_1 m2_2) (timesWord8# m3_1 m3_2) (timesWord8# m4_1 m4_2)

{-# INLINE quotWord8X4 #-}
-- | Rounds towards zero element-wise.
quotWord8X4 :: Word8X4 -> Word8X4 -> Word8X4
quotWord8X4 (Word8X4 m1_1 m2_1 m3_1 m4_1) (Word8X4 m1_2 m2_2 m3_2 m4_2) = Word8X4 (quotWord8# m1_1 m1_2) (quotWord8# m2_1 m2_2) (quotWord8# m3_1 m3_2) (quotWord8# m4_1 m4_2)

{-# INLINE remWord8X4 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord8X4 :: Word8X4 -> Word8X4 -> Word8X4
remWord8X4 (Word8X4 m1_1 m2_1 m3_1 m4_1) (Word8X4 m1_2 m2_2 m3_2 m4_2) = Word8X4 (remWord8# m1_1 m1_2) (remWord8# m2_1 m2_2) (remWord8# m3_1 m3_2) (remWord8# m4_1 m4_2)

{-# INLINE indexWord8X4Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord8X4Array :: ByteArray -> Int -> Word8X4
indexWord8X4Array (ByteArray a) (I# i) = Word8X4 (indexWord8Array# a ((i *# 4#) +# 0#)) (indexWord8Array# a ((i *# 4#) +# 1#)) (indexWord8Array# a ((i *# 4#) +# 2#)) (indexWord8Array# a ((i *# 4#) +# 3#))

{-# INLINE readWord8X4Array #-}
-- | Read a vector from specified index of the mutable array.
readWord8X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word8X4
readWord8X4Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord8Array# a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord8Array# a ((i *# 4#) +# 1#) s1 of
        (# s2, m2 #) -> case readWord8Array# a ((i *# 4#) +# 2#) s2 of
            (# s3, m3 #) -> case readWord8Array# a ((i *# 4#) +# 3#) s3 of
                (# s4, m4 #) -> (# s4, Word8X4 m1 m2 m3 m4 #))

{-# INLINE writeWord8X4Array #-}
-- | Write a vector to specified index of mutable array.
writeWord8X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word8X4 -> m ()
writeWord8X4Array (MutableByteArray a) (I# i) (Word8X4 m1 m2 m3 m4) = primitive_ (writeWord8Array# a ((i *# 4#) +# 0#) m1) >> primitive_ (writeWord8Array# a ((i *# 4#) +# 1#) m2) >> primitive_ (writeWord8Array# a ((i *# 4#) +# 2#) m3) >> primitive_ (writeWord8Array# a ((i *# 4#) +# 3#) m4)

{-# INLINE indexWord8X4OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord8X4OffAddr :: Addr -> Int -> Word8X4
indexWord8X4OffAddr (Addr a) (I# i) = Word8X4 (indexWord8OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0#) (indexWord8OffAddr# (plusAddr# a ((i *# 4#) +# 1#)) 0#) (indexWord8OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0#) (indexWord8OffAddr# (plusAddr# a ((i *# 4#) +# 3#)) 0#)

{-# INLINE readWord8X4OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord8X4OffAddr :: PrimMonad m => Addr -> Int -> m Word8X4
readWord8X4OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 1#) s1 of
        (# s2, m2 #) -> case (\ addr i' -> readWord8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 2#) s2 of
            (# s3, m3 #) -> case (\ addr i' -> readWord8OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 3#) s3 of
                (# s4, m4 #) -> (# s4, Word8X4 m1 m2 m3 m4 #))

{-# INLINE writeWord8X4OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord8X4OffAddr :: PrimMonad m => Addr -> Int -> Word8X4 -> m ()
writeWord8X4OffAddr (Addr a) (I# i) (Word8X4 m1 m2 m3 m4) = primitive_ (writeWord8OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0# m1) >> primitive_ (writeWord8OffAddr# (plusAddr# a ((i *# 4#) +# 1#)) 0# m2) >> primitive_ (writeWord8OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0# m3) >> primitive_ (writeWord8OffAddr# (plusAddr# a ((i *# 4#) +# 3#)) 0# m4)
