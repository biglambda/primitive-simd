...
-- ** Word16X2
data Word16X2 = Word16X2 Word# Word# deriving Typeable
...
broadcastWord16X2 (W16# x) = case broadcastWord16# x of
    v -> Word16X2 v v

{-# INLINE packWord16X2 #-}
-- | Pack the elements of a tuple into a vector.
packWord16X2 :: (Word16, Word16) -> Word16X2
packWord16X2 (W16# x1, W16# x2) = Word16X2 (packWord16# (# x1 #)) (packWord16# (# x2 #))

{-# INLINE unpackWord16X2 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord16X2 :: Word16X2 -> (Word16, Word16)
unpackWord16X2 (Word16X2 m1 m2) = case unpackWord16# m1 of
...
unsafeInsertWord16X2 (Word16X2 m1 m2) (W16# y) _i@(I# ip) | _i < 1 = Word16X2 (insertWord16# m1 y (ip -# 0#)) m2
                                                          | otherwise = Word16X2 m1 (insertWord16# m2 y (ip -# 1#))
...
plusWord16X2 (Word16X2 m1_1 m2_1) (Word16X2 m1_2 m2_2) = Word16X2 (plusWord16# m1_1 m1_2) (plusWord16# m2_1 m2_2)

{-# INLINE minusWord16X2 #-}
-- | Subtract two vectors element-wise.
minusWord16X2 :: Word16X2 -> Word16X2 -> Word16X2
minusWord16X2 (Word16X2 m1_1 m2_1) (Word16X2 m1_2 m2_2) = Word16X2 (minusWord16# m1_1 m1_2) (minusWord16# m2_1 m2_2)

{-# INLINE timesWord16X2 #-}
-- | Multiply two vectors element-wise.
timesWord16X2 :: Word16X2 -> Word16X2 -> Word16X2
timesWord16X2 (Word16X2 m1_1 m2_1) (Word16X2 m1_2 m2_2) = Word16X2 (timesWord16# m1_1 m1_2) (timesWord16# m2_1 m2_2)

{-# INLINE quotWord16X2 #-}
-- | Rounds towards zero element-wise.
quotWord16X2 :: Word16X2 -> Word16X2 -> Word16X2
quotWord16X2 (Word16X2 m1_1 m2_1) (Word16X2 m1_2 m2_2) = Word16X2 (quotWord16# m1_1 m1_2) (quotWord16# m2_1 m2_2)

{-# INLINE remWord16X2 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord16X2 :: Word16X2 -> Word16X2 -> Word16X2
remWord16X2 (Word16X2 m1_1 m2_1) (Word16X2 m1_2 m2_2) = Word16X2 (remWord16# m1_1 m1_2) (remWord16# m2_1 m2_2)

{-# INLINE indexWord16X2Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord16X2Array :: ByteArray -> Int -> Word16X2
indexWord16X2Array (ByteArray a) (I# i) = Word16X2 (indexWord16Array# a ((i *# 2#) +# 0#)) (indexWord16Array# a ((i *# 2#) +# 1#))

{-# INLINE readWord16X2Array #-}
-- | Read a vector from specified index of the mutable array.
readWord16X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word16X2
readWord16X2Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord16Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readWord16Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Word16X2 m1 m2 #))

{-# INLINE writeWord16X2Array #-}
-- | Write a vector to specified index of mutable array.
writeWord16X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word16X2 -> m ()
writeWord16X2Array (MutableByteArray a) (I# i) (Word16X2 m1 m2) = primitive_ (writeWord16Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeWord16Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexWord16X2OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord16X2OffAddr :: Addr -> Int -> Word16X2
indexWord16X2OffAddr (Addr a) (I# i) = Word16X2 (indexWord16OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0#) (indexWord16OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0#)

{-# INLINE readWord16X2OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord16X2OffAddr :: PrimMonad m => Addr -> Int -> m Word16X2
readWord16X2OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord16OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readWord16OffAddr# (plusAddr# addr i') 0#) a ((i *# 4#) +# 2#) s1 of
        (# s2, m2 #) -> (# s2, Word16X2 m1 m2 #))

{-# INLINE writeWord16X2OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord16X2OffAddr :: PrimMonad m => Addr -> Int -> Word16X2 -> m ()
writeWord16X2OffAddr (Addr a) (I# i) (Word16X2 m1 m2) = primitive_ (writeWord16OffAddr# (plusAddr# a ((i *# 4#) +# 0#)) 0# m1) >> primitive_ (writeWord16OffAddr# (plusAddr# a ((i *# 4#) +# 2#)) 0# m2)
