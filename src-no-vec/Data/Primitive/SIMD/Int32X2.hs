...
-- ** Int32X2
data Int32X2 = Int32X2 Int# Int# deriving Typeable
...
broadcastInt32X2 (I32# x) = case broadcastInt32# x of
    v -> Int32X2 v v

{-# INLINE packInt32X2 #-}
-- | Pack the elements of a tuple into a vector.
packInt32X2 :: (Int32, Int32) -> Int32X2
packInt32X2 (I32# x1, I32# x2) = Int32X2 (packInt32# (# x1 #)) (packInt32# (# x2 #))

{-# INLINE unpackInt32X2 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt32X2 :: Int32X2 -> (Int32, Int32)
unpackInt32X2 (Int32X2 m1 m2) = case unpackInt32# m1 of
...
unsafeInsertInt32X2 (Int32X2 m1 m2) (I32# y) _i@(I# ip) | _i < 1 = Int32X2 (insertInt32# m1 y (ip -# 0#)) m2
                                                        | otherwise = Int32X2 m1 (insertInt32# m2 y (ip -# 1#))
...
plusInt32X2 (Int32X2 m1_1 m2_1) (Int32X2 m1_2 m2_2) = Int32X2 (plusInt32# m1_1 m1_2) (plusInt32# m2_1 m2_2)

{-# INLINE minusInt32X2 #-}
-- | Subtract two vectors element-wise.
minusInt32X2 :: Int32X2 -> Int32X2 -> Int32X2
minusInt32X2 (Int32X2 m1_1 m2_1) (Int32X2 m1_2 m2_2) = Int32X2 (minusInt32# m1_1 m1_2) (minusInt32# m2_1 m2_2)

{-# INLINE timesInt32X2 #-}
-- | Multiply two vectors element-wise.
timesInt32X2 :: Int32X2 -> Int32X2 -> Int32X2
timesInt32X2 (Int32X2 m1_1 m2_1) (Int32X2 m1_2 m2_2) = Int32X2 (timesInt32# m1_1 m1_2) (timesInt32# m2_1 m2_2)

{-# INLINE quotInt32X2 #-}
-- | Rounds towards zero element-wise.
quotInt32X2 :: Int32X2 -> Int32X2 -> Int32X2
quotInt32X2 (Int32X2 m1_1 m2_1) (Int32X2 m1_2 m2_2) = Int32X2 (quotInt32# m1_1 m1_2) (quotInt32# m2_1 m2_2)

{-# INLINE remInt32X2 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt32X2 :: Int32X2 -> Int32X2 -> Int32X2
remInt32X2 (Int32X2 m1_1 m2_1) (Int32X2 m1_2 m2_2) = Int32X2 (remInt32# m1_1 m1_2) (remInt32# m2_1 m2_2)

{-# INLINE negateInt32X2 #-}
-- | Negate element-wise.
negateInt32X2 :: Int32X2 -> Int32X2
negateInt32X2 (Int32X2 m1_1 m2_1) = Int32X2 (negateInt32# m1_1) (negateInt32# m2_1)

{-# INLINE indexInt32X2Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt32X2Array :: ByteArray -> Int -> Int32X2
indexInt32X2Array (ByteArray a) (I# i) = Int32X2 (indexInt32Array# a ((i *# 2#) +# 0#)) (indexInt32Array# a ((i *# 2#) +# 1#))

{-# INLINE readInt32X2Array #-}
-- | Read a vector from specified index of the mutable array.
readInt32X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int32X2
readInt32X2Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt32Array# a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> case readInt32Array# a ((i *# 2#) +# 1#) s1 of
        (# s2, m2 #) -> (# s2, Int32X2 m1 m2 #))

{-# INLINE writeInt32X2Array #-}
-- | Write a vector to specified index of mutable array.
writeInt32X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int32X2 -> m ()
writeInt32X2Array (MutableByteArray a) (I# i) (Int32X2 m1 m2) = primitive_ (writeInt32Array# a ((i *# 2#) +# 0#) m1) >> primitive_ (writeInt32Array# a ((i *# 2#) +# 1#) m2)

{-# INLINE indexInt32X2OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt32X2OffAddr :: Addr -> Int -> Int32X2
indexInt32X2OffAddr (Addr a) (I# i) = Int32X2 (indexInt32OffAddr# (plusAddr# a ((i *# 8#) +# 0#)) 0#) (indexInt32OffAddr# (plusAddr# a ((i *# 8#) +# 4#)) 0#)

{-# INLINE readInt32X2OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt32X2OffAddr :: PrimMonad m => Addr -> Int -> m Int32X2
readInt32X2OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt32OffAddr# (plusAddr# addr i') 0#) a ((i *# 8#) +# 0#) s0 of
    (# s1, m1 #) -> case (\ addr i' -> readInt32OffAddr# (plusAddr# addr i') 0#) a ((i *# 8#) +# 4#) s1 of
        (# s2, m2 #) -> (# s2, Int32X2 m1 m2 #))

{-# INLINE writeInt32X2OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt32X2OffAddr :: PrimMonad m => Addr -> Int -> Int32X2 -> m ()
writeInt32X2OffAddr (Addr a) (I# i) (Int32X2 m1 m2) = primitive_ (writeInt32OffAddr# (plusAddr# a ((i *# 8#) +# 0#)) 0# m1) >> primitive_ (writeInt32OffAddr# (plusAddr# a ((i *# 8#) +# 4#)) 0# m2)
