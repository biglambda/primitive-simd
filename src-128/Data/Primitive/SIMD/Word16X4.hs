...
-- ** Word16X4
data Word16X4 = Word16X4 Word16X4# deriving Typeable
...
broadcastWord16X4 (W16# x) = Word16X4 (broadcastWord16X4# x)

{-# INLINE packWord16X4 #-}
-- | Pack the elements of a tuple into a vector.
packWord16X4 :: (Word16, Word16, Word16, Word16) -> Word16X4
packWord16X4 (W16# x1, W16# x2, W16# x3, W16# x4) = Word16X4 (packWord16X4# (# x1, x2, x3, x4 #))

{-# INLINE unpackWord16X4 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord16X4 :: Word16X4 -> (Word16, Word16, Word16, Word16)
unpackWord16X4 (Word16X4 m1) = case unpackWord16X4# m1 of
    (# x1, x2, x3, x4 #) -> (W16# x1, W16# x2, W16# x3, W16# x4)

{-# INLINE unsafeInsertWord16X4 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord16X4 :: Word16X4 -> Word16 -> Int -> Word16X4
unsafeInsertWord16X4 (Word16X4 m1) (W16# y) _i@(I# ip) = Word16X4 (insertWord16X4# m1 y (ip -# 0#))
...
plusWord16X4 (Word16X4 m1_1) (Word16X4 m1_2) = Word16X4 (plusWord16X4# m1_1 m1_2)

{-# INLINE minusWord16X4 #-}
-- | Subtract two vectors element-wise.
minusWord16X4 :: Word16X4 -> Word16X4 -> Word16X4
minusWord16X4 (Word16X4 m1_1) (Word16X4 m1_2) = Word16X4 (minusWord16X4# m1_1 m1_2)

{-# INLINE timesWord16X4 #-}
-- | Multiply two vectors element-wise.
timesWord16X4 :: Word16X4 -> Word16X4 -> Word16X4
timesWord16X4 (Word16X4 m1_1) (Word16X4 m1_2) = Word16X4 (timesWord16X4# m1_1 m1_2)

{-# INLINE quotWord16X4 #-}
-- | Rounds towards zero element-wise.
quotWord16X4 :: Word16X4 -> Word16X4 -> Word16X4
quotWord16X4 (Word16X4 m1_1) (Word16X4 m1_2) = Word16X4 (quotWord16X4# m1_1 m1_2)

{-# INLINE remWord16X4 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord16X4 :: Word16X4 -> Word16X4 -> Word16X4
remWord16X4 (Word16X4 m1_1) (Word16X4 m1_2) = Word16X4 (remWord16X4# m1_1 m1_2)

{-# INLINE indexWord16X4Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord16X4Array :: ByteArray -> Int -> Word16X4
indexWord16X4Array (ByteArray a) (I# i) = Word16X4 (indexWord16X4Array# a i)

{-# INLINE readWord16X4Array #-}
-- | Read a vector from specified index of the mutable array.
readWord16X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word16X4
readWord16X4Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord16X4Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word16X4 m1 #))

{-# INLINE writeWord16X4Array #-}
-- | Write a vector to specified index of mutable array.
writeWord16X4Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word16X4 -> m ()
writeWord16X4Array (MutableByteArray a) (I# i) (Word16X4 m1) = primitive_ (writeWord16X4Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexWord16X4OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord16X4OffAddr :: Addr -> Int -> Word16X4
indexWord16X4OffAddr (Addr a) (I# i) = Word16X4 (indexWord16X4OffAddr# (plusAddr# a (i *# 8#)) 0#)

{-# INLINE readWord16X4OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord16X4OffAddr :: PrimMonad m => Addr -> Int -> m Word16X4
readWord16X4OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord16X4OffAddr# (plusAddr# addr i') 0#) a ((i *# 8#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word16X4 m1 #))

{-# INLINE writeWord16X4OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord16X4OffAddr :: PrimMonad m => Addr -> Int -> Word16X4 -> m ()
writeWord16X4OffAddr (Addr a) (I# i) (Word16X4 m1) = primitive_ (writeWord16X4OffAddr# (plusAddr# a ((i *# 8#) +# 0#)) 0# m1)
