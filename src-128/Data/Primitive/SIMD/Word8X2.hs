...
-- ** Word8X2
data Word8X2 = Word8X2 Word8X2# deriving Typeable
...
broadcastWord8X2 (W8# x) = Word8X2 (broadcastWord8X2# x)

{-# INLINE packWord8X2 #-}
-- | Pack the elements of a tuple into a vector.
packWord8X2 :: (Word8, Word8) -> Word8X2
packWord8X2 (W8# x1, W8# x2) = Word8X2 (packWord8X2# (# x1, x2 #))

{-# INLINE unpackWord8X2 #-}
-- | Unpack the elements of a vector into a tuple.
unpackWord8X2 :: Word8X2 -> (Word8, Word8)
unpackWord8X2 (Word8X2 m1) = case unpackWord8X2# m1 of
    (# x1, x2 #) -> (W8# x1, W8# x2)

{-# INLINE unsafeInsertWord8X2 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertWord8X2 :: Word8X2 -> Word8 -> Int -> Word8X2
unsafeInsertWord8X2 (Word8X2 m1) (W8# y) _i@(I# ip) = Word8X2 (insertWord8X2# m1 y (ip -# 0#))
...
plusWord8X2 (Word8X2 m1_1) (Word8X2 m1_2) = Word8X2 (plusWord8X2# m1_1 m1_2)

{-# INLINE minusWord8X2 #-}
-- | Subtract two vectors element-wise.
minusWord8X2 :: Word8X2 -> Word8X2 -> Word8X2
minusWord8X2 (Word8X2 m1_1) (Word8X2 m1_2) = Word8X2 (minusWord8X2# m1_1 m1_2)

{-# INLINE timesWord8X2 #-}
-- | Multiply two vectors element-wise.
timesWord8X2 :: Word8X2 -> Word8X2 -> Word8X2
timesWord8X2 (Word8X2 m1_1) (Word8X2 m1_2) = Word8X2 (timesWord8X2# m1_1 m1_2)

{-# INLINE quotWord8X2 #-}
-- | Rounds towards zero element-wise.
quotWord8X2 :: Word8X2 -> Word8X2 -> Word8X2
quotWord8X2 (Word8X2 m1_1) (Word8X2 m1_2) = Word8X2 (quotWord8X2# m1_1 m1_2)

{-# INLINE remWord8X2 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remWord8X2 :: Word8X2 -> Word8X2 -> Word8X2
remWord8X2 (Word8X2 m1_1) (Word8X2 m1_2) = Word8X2 (remWord8X2# m1_1 m1_2)

{-# INLINE indexWord8X2Array #-}
-- | Read a vector from specified index of the immutable array.
indexWord8X2Array :: ByteArray -> Int -> Word8X2
indexWord8X2Array (ByteArray a) (I# i) = Word8X2 (indexWord8X2Array# a i)

{-# INLINE readWord8X2Array #-}
-- | Read a vector from specified index of the mutable array.
readWord8X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Word8X2
readWord8X2Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readWord8X2Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word8X2 m1 #))

{-# INLINE writeWord8X2Array #-}
-- | Write a vector to specified index of mutable array.
writeWord8X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Word8X2 -> m ()
writeWord8X2Array (MutableByteArray a) (I# i) (Word8X2 m1) = primitive_ (writeWord8X2Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexWord8X2OffAddr #-}
-- | Reads vector from the specified index of the address.
indexWord8X2OffAddr :: Addr -> Int -> Word8X2
indexWord8X2OffAddr (Addr a) (I# i) = Word8X2 (indexWord8X2OffAddr# (plusAddr# a (i *# 2#)) 0#)

{-# INLINE readWord8X2OffAddr #-}
-- | Reads vector from the specified index of the address.
readWord8X2OffAddr :: PrimMonad m => Addr -> Int -> m Word8X2
readWord8X2OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readWord8X2OffAddr# (plusAddr# addr i') 0#) a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Word8X2 m1 #))

{-# INLINE writeWord8X2OffAddr #-}
-- | Write vector to the specified index of the address.
writeWord8X2OffAddr :: PrimMonad m => Addr -> Int -> Word8X2 -> m ()
writeWord8X2OffAddr (Addr a) (I# i) (Word8X2 m1) = primitive_ (writeWord8X2OffAddr# (plusAddr# a ((i *# 2#) +# 0#)) 0# m1)
