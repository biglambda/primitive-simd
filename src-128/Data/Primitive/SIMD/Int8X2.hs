...
-- ** Int8X2
data Int8X2 = Int8X2 Int8X2# deriving Typeable
...
broadcastInt8X2 (I8# x) = Int8X2 (broadcastInt8X2# x)

{-# INLINE packInt8X2 #-}
-- | Pack the elements of a tuple into a vector.
packInt8X2 :: (Int8, Int8) -> Int8X2
packInt8X2 (I8# x1, I8# x2) = Int8X2 (packInt8X2# (# x1, x2 #))

{-# INLINE unpackInt8X2 #-}
-- | Unpack the elements of a vector into a tuple.
unpackInt8X2 :: Int8X2 -> (Int8, Int8)
unpackInt8X2 (Int8X2 m1) = case unpackInt8X2# m1 of
    (# x1, x2 #) -> (I8# x1, I8# x2)

{-# INLINE unsafeInsertInt8X2 #-}
-- | Insert a scalar at the given position (starting from 0) in a vector. If the index is outside of the range, the behavior is undefined.
unsafeInsertInt8X2 :: Int8X2 -> Int8 -> Int -> Int8X2
unsafeInsertInt8X2 (Int8X2 m1) (I8# y) _i@(I# ip) = Int8X2 (insertInt8X2# m1 y (ip -# 0#))
...
plusInt8X2 (Int8X2 m1_1) (Int8X2 m1_2) = Int8X2 (plusInt8X2# m1_1 m1_2)

{-# INLINE minusInt8X2 #-}
-- | Subtract two vectors element-wise.
minusInt8X2 :: Int8X2 -> Int8X2 -> Int8X2
minusInt8X2 (Int8X2 m1_1) (Int8X2 m1_2) = Int8X2 (minusInt8X2# m1_1 m1_2)

{-# INLINE timesInt8X2 #-}
-- | Multiply two vectors element-wise.
timesInt8X2 :: Int8X2 -> Int8X2 -> Int8X2
timesInt8X2 (Int8X2 m1_1) (Int8X2 m1_2) = Int8X2 (timesInt8X2# m1_1 m1_2)

{-# INLINE quotInt8X2 #-}
-- | Rounds towards zero element-wise.
quotInt8X2 :: Int8X2 -> Int8X2 -> Int8X2
quotInt8X2 (Int8X2 m1_1) (Int8X2 m1_2) = Int8X2 (quotInt8X2# m1_1 m1_2)

{-# INLINE remInt8X2 #-}
-- | Satisfies (quot x y) * y + (rem x y) == x.
remInt8X2 :: Int8X2 -> Int8X2 -> Int8X2
remInt8X2 (Int8X2 m1_1) (Int8X2 m1_2) = Int8X2 (remInt8X2# m1_1 m1_2)

{-# INLINE negateInt8X2 #-}
-- | Negate element-wise.
negateInt8X2 :: Int8X2 -> Int8X2
negateInt8X2 (Int8X2 m1_1) = Int8X2 (negateInt8X2# m1_1)

{-# INLINE indexInt8X2Array #-}
-- | Read a vector from specified index of the immutable array.
indexInt8X2Array :: ByteArray -> Int -> Int8X2
indexInt8X2Array (ByteArray a) (I# i) = Int8X2 (indexInt8X2Array# a i)

{-# INLINE readInt8X2Array #-}
-- | Read a vector from specified index of the mutable array.
readInt8X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> m Int8X2
readInt8X2Array (MutableByteArray a) (I# i) = primitive (\ s0 -> case readInt8X2Array# a ((i *# 1#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int8X2 m1 #))

{-# INLINE writeInt8X2Array #-}
-- | Write a vector to specified index of mutable array.
writeInt8X2Array :: PrimMonad m => MutableByteArray (PrimState m) -> Int -> Int8X2 -> m ()
writeInt8X2Array (MutableByteArray a) (I# i) (Int8X2 m1) = primitive_ (writeInt8X2Array# a ((i *# 1#) +# 0#) m1)

{-# INLINE indexInt8X2OffAddr #-}
-- | Reads vector from the specified index of the address.
indexInt8X2OffAddr :: Addr -> Int -> Int8X2
indexInt8X2OffAddr (Addr a) (I# i) = Int8X2 (indexInt8X2OffAddr# (plusAddr# a (i *# 2#)) 0#)

{-# INLINE readInt8X2OffAddr #-}
-- | Reads vector from the specified index of the address.
readInt8X2OffAddr :: PrimMonad m => Addr -> Int -> m Int8X2
readInt8X2OffAddr (Addr a) (I# i) = primitive (\ s0 -> case (\ addr i' -> readInt8X2OffAddr# (plusAddr# addr i') 0#) a ((i *# 2#) +# 0#) s0 of
    (# s1, m1 #) -> (# s1, Int8X2 m1 #))

{-# INLINE writeInt8X2OffAddr #-}
-- | Write vector to the specified index of the address.
writeInt8X2OffAddr :: PrimMonad m => Addr -> Int -> Int8X2 -> m ()
writeInt8X2OffAddr (Addr a) (I# i) (Int8X2 m1) = primitive_ (writeInt8X2OffAddr# (plusAddr# a ((i *# 2#) +# 0#)) 0# m1)
